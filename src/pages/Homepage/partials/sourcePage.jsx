  ...
  return (
    ...
    <div className="flex flex-col items-center justify-start w-full gap-7">
      <div className="flex flex-row justify-between items-start w-full">
        ...
        >
         <Link to={`/${props.category}`}> View All</Link>  
        </Button>
      </div>
    ...
    <div className="flex flex-row md:flex-col w-full gap-[19px]">
      {articles.map((ele)=>{
      return <div className="flex flex-col items-start justify-start w-[33%] md:w-full gap-5"  key={ele.url}>
        ...
        <div className="flex flex-col items-center justify-start">
          ...
          {ele.title ? ele.title.slice(0, 100) : ''}
          </Heading>
          <Text
            as="p"
